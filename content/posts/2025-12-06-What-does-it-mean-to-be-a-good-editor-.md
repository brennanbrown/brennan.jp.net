+++
title = "What does it mean to be a good editor?"
date = 2025-12-06T00:00:00-07:00
categories = ["Writing Process"]
tags = ["personal essay", "publishing"]
description = "Accessibility, Gatekeeping, and Who Gets to be Published"
featured_image = 'https://cdn-images-1.medium.com/max/800/0*d-JqdGIJOldW9ifh'
featured_image_alt = "Photo by Donald Giannatti on Unsplash"
featured_image_caption = "Photo by Donald Giannatti on Unsplash"
+++
...
Instead, I choose to independently publish through distribution channels like [Kindle Direct Publishing](https://kdp.amazon.com) and [Lulu Press](https://www.lulu.com/) for softcovers and hardbacks, and [Gumroad](https://brennanbrown.gumroad.com) for digital ebooks. During my tenure at [Write Club](https://writeclub.ca), I was president with two anthologies being published this way: [*A Collection of Filth*](https://www.amazon.com/Fringe-Collection-Filth-Dana%C3%AB-Webb/dp/B0CYQ1NRY9?crid=ABRCLL8U0Z47) and [*A Collection of Community*](https://www.amazon.com/Fringe-Collection-Felix-Costa-Gomez/dp/B0F4PKFRZQ).

[Getting your first work published is the hardest threshold to cross](https://www.writersrelief.com/writing-submission-advice-i-wish-id-known-sooner-writers-relief/). Seeing your name in print, even in a publication with a circulation of twelve copies, changes something fundamental about how you see yourself. You stop being someone who writes. You become a writer. An author.
...
The [rejection rate in traditional literary magazines hovers around 90–95%](https://womenwhosubmitlit.org/2021/06/16/submissions-the-harsh-reality-and-how-to-improve-your-odds/). Student magazines matter precisely because they can be someone’s first publication, there’s no terrifying barrier to entry, but rather the beginning of a career rather than another closed door.

Writer and educator Khalisa Rae identifies a fundamental problem in literary communities, that [“there’s so much not just gatekeeping, but there’s also this like secrecy in the writing community that only the elite get to know about opportunities like fellowships and grants and awards.”](https://www.morganstanley.com/ideas/carla-harris-diversity-in-publishing-access-and-opportunity-podcast) Not only are certain voices excluded, but the mechanisms of access remain deliberately obscure.

The Harvard Crimson argues that gatekeeping operates through institutional inertia, where [“educational institutions have provided clear evidence that the canon is largely inaccessible to readers without a fancy degree.”](https://www.thecrimson.com/article/2022/10/4/cho-literary-canon/) The very spaces meant to foster literary appreciation become barriers to entry.
...
**The tent.** [Big, messy, open on all sides](https://en.wikipedia.org/wiki/Big_tent). Room for the polished and the rough. The traditional and the experimental. The writer who’s been doing this for twenty years and the person who just discovered they have something to say. A broad spectrum of views and approaches, held together not by shared aesthetic but by shared commitment to the work itself.

What’s the precedent for this? Lighthouse Writers Workshop commits to being [“a diverse, inclusive, and equitable place where all participants…feel valued and respected”](https://lighthousewriters.org/equity-diversity-inclusivity-and-accessibility) [Hugo House](https://hugohouse.org/about/) operates on the Philosophy that “everyone has a story to tell.” [Literary Arts emphasizes](https://literary-arts.org/what-we-do/writing-classes/) they “want writing classes to be accessible to everyone, regardless of income and background.”

Kristin Nelson from [Nelson Literary Agency](https://nelsonagency.com/2008/05/the-personalized-rejection-letter/) explicitly states:
...
Medium sits in an uncomfortable middle ground. The platform promises democratization. Yes, anyone can publish, anyone can be read. But [Medium publications](https://www.zuliewrites.com/blog/what-is-a-medium-publication) operate as miniature literary magazines, complete with submission guidelines, editorial standards, and the same vague rejections that plague traditional publishing.
...
5.  **Remember: rejection on Medium often means nothing.** Unlike traditional publishing where editors have training and editorial standards are institutionally vetted, Medium publication editors are just… people with Medium accounts. Some are brilliant. Some aren’t.
The gatekeeping on Medium masquerades as democratization. “Anyone can start a publication!” Sure. But that doesn’t mean everyone should. And it certainly doesn’t mean every publication deserves the deference we give to actual literary institutions.
